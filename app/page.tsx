                        ...
                        <Tab.Pane eventKey="nextjs" className='border-0'>
                                <div className="p-4">
                                    ...
                                    <div className="row gy-3">
                                        ...
                                        <Col xl={12} className="mb-2">
                                            <Form.Label htmlFor="signin-password" className="form-label text-default d-block">Password
                                                <Link href="#!" scroll={false} className="float-end text-danger">Forget password ?</Link></Form.Label>
                                            <InputGroup>
                                                <Form.Control size="lg"
                                                    className="form-control"
                                    ...
                                    <div className="text-center">
                                        <p className="fs-12 text-muted mt-3">Dont have an account? <Link href="#!" className="text-primary">Sign Up</Link></p>
                                    </div>
                            ...
                            <Tab.Pane eventKey="firebase" className='border-0'>
                                <div className="p-4">
                                    ...
                                    <div className="text-center">
                                        <p className="fs-12 text-muted mt-3">Dont have an account? <Link href="#!" scroll={false} className="text-primary">Sign Up</Link></p>
                                    </div>
                                    <div className="text-center my-3 authentication-barrier">
                                        <span>OR</span>
                                    </div>
